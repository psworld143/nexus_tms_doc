...
<link rel="stylesheet" href="css/dispatch.css?v=1">
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .nav-link svg { width: 19px; height: 19px; flex-shrink: 0; color: var(--text-muted); transition: color 0.16s ease; }
            .nav-link:hover {
                background: color-mix(in srgb, var(--surface-solid) 50%, transparent);
            ...
            /* ===== Search Assistant ===== */
            /* ===== Settings Panel — moved to css/dispatch.css ===== */
            ...
            /* Accessibility: Reduce Motion + High Contrast — moved to css/dispatch.css */
    ...
    <body>
        ...
        <!-- Tour Guide overlay injected by js/tour-guide.js -->
        ...
        <script>
            // Doc data injected from PHP (shared doc_data.php) — consumed by js/index-modal.js
            window.DOC_DATA = <?php
                $availableMap = [];
