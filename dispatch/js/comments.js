        ...
        var html =
            '<div class="comment-item-header">' +
                ...
                '<div class="comment-meta">' +
                    ...
                    '<div class="comment-time">' + escapeHtml(timeAgo(comment.timestamp)) + '</div>' +
                '</div>' +
            '</div>' +
    ...
    function wireCommentActions(item) {
        ...
        if (replyBtn) {
            replyBtn.addEventListener('click', function() {
                var form = document.getElementById('reply-form-' + replyBtn.dataset.id);
        ...
        if (replySubmit) {
            replySubmit.addEventListener('click', function() { handleReplySubmit(replySubmit); });
        }
        // Cancel reply
        var cancelBtn = item.querySelector('.cancel-reply-btn');
        if (cancelBtn) {
            cancelBtn.addEventListener('click', function() {
                var form = document.getElementById('reply-form-' + cancelBtn.dataset.id);
    ...
    window.DispatchComments = {
        ...
        init: function(videoId) {
            if (document.readyState === 'loading') {
                document.addEventListener('DOMContentLoaded', function() { initMainForm(); fetchComments(videoId); startNotificationPolling(); });
            } else {
                initMainForm();
